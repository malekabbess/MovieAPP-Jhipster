...
import tn.moviesapp.project.domain.enumeration.Role;
import tn.moviesapp.project.repository.StaffRepository;
...
class StaffResourceIT {
    ...
    void partialUpdateStaffWithPatch() throws Exception {
        ...
        partialUpdatedStaff.role(UPDATED_ROLE).lastName(UPDATED_LAST_NAME);
