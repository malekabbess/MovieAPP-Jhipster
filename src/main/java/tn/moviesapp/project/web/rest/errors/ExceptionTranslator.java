...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof tn.moviesapp.project.service.EmailAlreadyUsedException ||
            ex instanceof tn.moviesapp.project.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof tn.moviesapp.project.service.InvalidPasswordException
