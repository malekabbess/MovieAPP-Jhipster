    ...
    <Row>
      <Col md="8">
        <h2 data-cy="movieDetailsHeading">
          <Translate contentKey="moviesAppApp.movie.detail.title">Movie</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="name">
              <Translate contentKey="moviesAppApp.movie.name">Name</Translate>
            </span>
          </dt>
          ...
          <dt>
            <Translate contentKey="moviesAppApp.movie.membreStaff">Membre Staff</Translate>
          </dt>
          <dd>
          ...
          <dt>
            <Translate contentKey="moviesAppApp.movie.category">Category</Translate>
          </dt>
          <dd>
